...
DEFAULT={'episodic_memory':True,'listening':False,'speak':True,'memory':'Your name is David. You use an ASUS ROG Flow Z13 with CachyOS. You prefer a warm British female assistant named Jinx.','reminders':[],'pending':[]}
